...
//   const refreshDiscoverScreen = useSelector(
//     (state) => state.handleUseffect.refreshDiscoverScreen
//   );
...
//   useEffect(() => {
//     if (refreshDiscoverScreen || assistantId) {
//       getDocuments();
//       dispatch(
//         handleUseffectActions.setRefreshDiscoverScreen({ reload: false })
//       );
//     }
//   }, [assistantId, refreshDiscoverScreen]);
...
//           <View style={styles.memberInnerRight}>
//             {documentDeleting.get(`item-${item.id}`) === true ? (
//               <ActivityIndicator></ActivityIndicator>
//             ) : (
//               <TouchableOpacity
//                 style={styles.removeIcon}
//                 onPress={() => {
//                   deleteDocumentFromAssistant(item.document_id, item.id);
//                 }}
//               >
//                 <Svg viewBox="0 0 24 24" width={12} height={12}>
//                   <Path d="M0 0h24v24H0z" fill="none"></Path>
//                   <Path fill="black" d="M19 13H5v-2h14v2z"></Path>
//                 </Svg>
//               </TouchableOpacity>
//             )}
//           </View>
...
//       setLoading(true);
//       const response = await api.get(
//         `${baseURL}/api/user/getUserAssistantName`
//       );
//       setProfilePic(response.data.profile);
//       setAssitantName(response.data.message);
...
//               }}
//               onPress={() => {
//                 navigation.navigate("UploadDocUser", {
...
//                   <Text style={styles.ResetText}>Reset knowledge Base</Text>
//                 </TouchableOpacity>
//               </View>
//             </Modal>
//           </KeyboardAvoidingView>
